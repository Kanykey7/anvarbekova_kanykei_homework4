...
public class Main {
    ...
    public static int[] heroesHealth = {250, 270, 280, 300, 260, 240, 290, 230};
    public static int[] heroesDamage = {25, 20, 15, 0, 10, 20, 15, 30};
        ...
        if (heroesHealth[7] > 0 && bossHealth > 0){
            switch (randomC){
                case 1:
                    ...
                    System.out.println("Урон Берсерка критический");
                    System.out.println("Потери при увеличении урона Берсерка");
                    break;
                case 2:
                    bossDamage = 50 ;
                    break;
